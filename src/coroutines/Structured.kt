package coroutines.structured

import kotlinx.coroutines.experimental.runBlocking
import java.util.Random

// We have a worker who makes machines every 800ms as long as there is less than 5 of them
// Every machine produces a code using `produce` function every second. It saves this code to shared space. In case of error, it ends working.
